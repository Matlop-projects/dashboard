...
export class BlogDetailsComponent {
    ...
    this.ApiService.get(`${global_API_deialis}/${this.getID}`).subscribe(
      (res: any) => {
        if (res) {
          ...
          this.editImageProps_ar.props.imgSrc =
            this.imageUrl + res.data.coverAr;
  ...
  navigateToPageTable() {
    this.router.navigateByUrl('/settings/blog');
  }
