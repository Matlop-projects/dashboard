...
@Component({
  ...
  templateUrl: './reviewtechnical-table.component.html',
  styleUrl: './reviewtechnical-table.component.scss'
})
...
showCommentMessage=false
  ...
  displayTableCols(currentLang: string) {
    this.columns = [
      ...
      },
      {
        ...
        header: this.languageService.translate(
          'tech_reviews.form.technicalName'
        ),
        type: EType.text,
        show: true,
      },
      ...
      },
      {
        ...
        header: this.languageService.translate(
          'tech_reviews.form.creationTime'
        ),
        type: EType.date,
        show: true,
      },
  ...
  onConfirmMessage(record?:any){
    this.showConfirmMessage = true;
    this.callDeleteApi(record);
  }
  getBreadCrumb() {
    this.bredCrumb = {
      crumbs: [
