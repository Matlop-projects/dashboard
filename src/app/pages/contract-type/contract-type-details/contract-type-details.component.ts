...
export class ContractTypeDetailsComponent {
  ...
  API_getItemDetails() {
    this.ApiService.get(API.CONTRACT_TYPES.BY_ID(this.getID)).subscribe((res: any) => {
      if (res){
  ...
  API_forAddItem(payload: any) {
    this.ApiService.post(API.CONTRACT_TYPES.BASE, payload).subscribe(res => {
      if (res)
        this.navigateToPageTable()
    })
  }
  ...
  API_forEditItem(payload: any) {
    this.ApiService.put(API.CONTRACT_TYPES.BASE, payload).subscribe(res => {
      if (res)
        this.navigateToPageTable()
    })
  }
