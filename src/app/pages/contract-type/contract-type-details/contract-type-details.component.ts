...
export class ContractTypeDetailsComponent {
  ...
  API_forAddItem(payload: any) {
    this.ApiService.post(global_API_create, payload, { showAlert: true, message: `` }).subscribe(res => {
      if (res)
        this.navigateToPageTable()
    })
  }
  ...
  API_forEditItem(payload: any) {
    this.ApiService.put(global_API_update, payload, { showAlert: true, message: `` }).subscribe(res => {
      if (res)
        this.navigateToPageTable()
    })
  }
